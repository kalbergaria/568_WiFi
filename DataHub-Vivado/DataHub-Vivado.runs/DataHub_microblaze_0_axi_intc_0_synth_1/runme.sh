...
HD_PWD='C:/Users/Keith/Documents/Git/DataHub/DataHub-Vivado/DataHub-Vivado.runs/DataHub_microblaze_0_axi_intc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DataHub_microblaze_0_axi_intc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DataHub_microblaze_0_axi_intc_0.tcl
