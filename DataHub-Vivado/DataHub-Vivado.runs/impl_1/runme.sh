...
HD_PWD='C:/Users/Keith/Documents/Git/568_Hub/568_WiFi/DataHub-Vivado/DataHub-Vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DataHub_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DataHub_wrapper.tcl -notrace
